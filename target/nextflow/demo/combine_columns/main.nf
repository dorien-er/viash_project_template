...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.R",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/viash_project_template/viash_project_template/src/demo/combine_columns/config.vsh.yaml"
      }
    ],
    "status" : "enabled",
  ...
  "info" : {
    "config" : "/home/runner/work/viash_project_template/viash_project_template/src/demo/combine_columns/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.7",
    "git_commit" : "847d5a1884d340cd17d1b3d6509ed78920c91333",
...
par <- list(
  ...
  "id" = $( if [ ! -z ${VIASH_PAR_ID+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_ID" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi )
)
meta <- list(
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-io/viash_project_template/demo_combine_columns",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
