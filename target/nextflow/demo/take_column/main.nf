...
thisConfig = processConfig(jsonSlurper.parseText('''{
    ...
    "resources" : [
      {
        ...
        "path" : "script.py",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/viash_project_template/viash_project_template/src/demo/take_column/config.vsh.yaml"
      }
    ],
    "status" : "enabled",
  ...
  "info" : {
    "config" : "/home/runner/work/viash_project_template/viash_project_template/src/demo/take_column/config.vsh.yaml",
    "platform" : "nextflow",
    "viash_version" : "0.6.7",
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-io/viash_project_template/demo_take_column",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
