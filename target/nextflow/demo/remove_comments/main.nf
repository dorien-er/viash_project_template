    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/viash_project_template/viash_project_template/src/demo/remove_comments/config.vsh.yaml"
      }
    ],
    "test_resources" : [
      {
...
thisDefaultProcessArgs = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-io/viash_project_template/demo_remove_comments",
    "tag" : "main_build"
  },
  "tag" : "$id"
}'''),
